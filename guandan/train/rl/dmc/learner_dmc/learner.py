...
parser.add_argument('--pool_size', type=int, default=50000, help='The max length of data pool')
parser.add_argument('--batch_size', type=int, default=10240, help='The batch size for training')
parser.add_argument('--training_freq', type=int, default=1000,
