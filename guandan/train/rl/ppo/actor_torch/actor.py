...
parser.add_argument('--exp_path', type=str, default='/data/biaoweilin/guandan/torch_version/danzero_torch/danzero_plus/log',
...
class Player():
    def __init__(self, args) -> None:
        ...
        self.model = MLPActorCritic((ActionNumber, 513 + ActionNumber * 54), ActionNumber)
        self.model_q = MLPQNetwork(567)
        # with open('/data/biaoweilin/guandan/torch_version/danzero_torch/danzero_plus/actor_torch/q_network.ckpt', 'rb') as f:  # load DMC model
        #     tf_weights = pickle.load(f)
        # self.model_q.load_tf_weights(tf_weights)
        self.model_q.load_state_dict(torch.load("/data/biaoweilin/guandan/torch_version/danzero_torch/danzero_plus/actor_torch/q_network.pth"))
        ...
        # 模型文件路径
        self.args.ckpt_path = Path('/data/biaoweilin/guandan/torch_version/danzero_torch/danzero_plus/learner_torch/ckpt_bak')
        # 开模型订阅
